...
class WasteTracker:
    ...
    def save_evidence(self, entity_id, frame_buffer, current_frame, entity_type):
        ...
        # Save original frames as files
        for idx, frame in enumerate(frame_buffer):
            frame_clone = frame.copy()
            cv2.rectangle(frame_clone, (x1, y1), (x2, y2), (0, 0, 255), 2)
            cv2.putText(frame_clone, f"{entity_type.capitalize()} ID {entity_id}", 
                       (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
...
if __name__ == "__main__":
    ...
    video_path = r"C:\Users\DELL\Desktop\trash\veh_pavi\vehidet\vid1.mp4"
